...
class TestCalibrationCurve:
    ...
    # Just test simplest version of normal case

    def test_configure_show_density_settings(self):
        pass

    # Normal case where every input value is valid
    # Case where each input is bad
    # Case where self.method == 'frequency'  - warning should be shown
